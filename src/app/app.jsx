			...
			<div id="wrapper">
				<div id="main">
					...
					<div className="inner">
						...
						<hr id="divider01"/><p id="text02">Классный парень</p>
							<ul id="icons01" className="icons">
								<li><a className="n01" href="http://domain.tld/path">
									<svg>
										<use xmlnsXlink={"http://www.w3.org/1999/xlink"} xlinkHref={"#icon-905"}/>
									</svg>
									<span className="label">Twitter</span></a></li>
								<li><a className="n02" href="http://domain.tld/path">
									<svg>
										<use xmlnsXlink={"http://www.w3.org/1999/xlink"} xlinkHref={"#icon-910"}/>
									</svg>
									<span className="label">Instagram</span></a></li>
								<li><a className="n03" href="http://domain.tld/path">
									<svg>
										<use xmlnsXlink={"http://www.w3.org/1999/xlink"} xlinkHref={"#icon-906"}/>
									</svg>
